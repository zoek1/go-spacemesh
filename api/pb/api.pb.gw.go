...
func request_SpaceMeshService_RegisterProtocol_0(ctx context.Context, marshaler runtime.Marshaler, client SpaceMeshServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Protocol
	var metadata runtime.ServerMetadata
	...
	msg, err := client.RegisterProtocol(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func request_SpaceMeshService_SendMessage_0(ctx context.Context, marshaler runtime.Marshaler, client SpaceMeshServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSpaceMeshServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SpaceMeshServiceClient) error {
	...
	mux.Handle("POST", pattern_SpaceMeshService_RegisterProtocol_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_SpaceMeshService_RegisterProtocol_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SpaceMeshService_RegisterProtocol_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_SpaceMeshService_SendMessage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_SpaceMeshService_SendMessage_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SpaceMeshService_SendMessage_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_SpaceMeshService_RegisterProtocol_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "register"}, ""))

	pattern_SpaceMeshService_SendMessage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "send"}, ""))

	pattern_SpaceMeshService_Broadcast_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "broadcast"}, ""))
)

var (
	forward_SpaceMeshService_Echo_0 = runtime.ForwardResponseMessage

	forward_SpaceMeshService_RegisterProtocol_0 = runtime.ForwardResponseMessage

	forward_SpaceMeshService_SendMessage_0 = runtime.ForwardResponseMessage
