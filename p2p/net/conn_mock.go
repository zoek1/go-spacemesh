...
func NewConnectionMock(key cryptoSign.PublicKey) *ConnectionMock {
...
func (cm ConnectionMock) RemotePublicKey() cryptoSign.PublicKey {
	return cm.remotePub
}

func (cm *ConnectionMock) SetRemotePublicKey(key cryptoSign.PublicKey) {
	cm.remotePub = key
}
