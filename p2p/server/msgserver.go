...
type Service interface {
	service.Service
	SendWrappedMessage(nodeID cryptoSign.PublicKey, protocol string, payload *service.DataMsgWrapper) error
}
...
func (p *MessageServer) handleRequestMessage(sender cryptoSign.PublicKey, headers *service.DataMsgWrapper) {
...
func (p *MessageServer) SendRequest(msgType MessageType, payload []byte, address cryptoSign.PublicKey, resHandler func(msg []byte)) error {
