...
func (p *Ping) Ping(target cryptoSign.PublicKey, msg string) (string, error) {
	var response string
...
func (p *Ping) sendRequest(target cryptoSign.PublicKey, reqid crypto.UUID, ping *pb.Ping) (chan *pb.Ping, error) {
